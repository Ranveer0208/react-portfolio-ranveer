   ...
   return <>
      <div className="nav flex items-center justify-between px-10 md:px-20 py-6 w-full  text-white">
         ...
         <div className="right flex md:space-x-6 space-x-4 hover:cursor-pointer text-sm md:text-2xl">
            <div><a href="https://www.linkedin.com/in/ranveer-varada-679018165" className="hover:text-blue-500"><FaLinkedin className="s" /></a></div>
            <div><a href="https://github.com/Ranveer0208/" className="hover:text-slate-600"><FaGithub /></a></div>
